		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori with AI",
									"targetURL": "#comsaptrialfioriai-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsaptrialfioriai-display": {
								"semanticObject": "comsaptrialfioriai",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.trial.fioriai",
									"url": sap.ui.require.toUrl("com/sap/trial/fioriai")
								}
							}
						}
					}
